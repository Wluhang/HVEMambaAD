...
if __name__ == '__main__':
    ...
    parser.add_argument('--model_id', type=str, default='MSL', help='model id')
    parser.add_argument('--model', type=str, required=True, default='HVEMambaAD')

    # data loader
    parser.add_argument('--data', type=str, required=True, default='MSL', help='dataset type')
